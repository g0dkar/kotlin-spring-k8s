...
public class VisitorTypeEnum extends TableImpl<VisitorTypeEnumRecord> {
    ...
    private static final long serialVersionUID = 1785651807;
    ...
    /**
     * The column <code>public.visitor_type_enum.created</code>.
     */
    public final TableField<VisitorTypeEnumRecord, OffsetDateTime> CREATED = createField(DSL.name("created"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE.nullable(false), this, "");
